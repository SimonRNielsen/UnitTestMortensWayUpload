...
namespace UnitTestMortensWay
{
    ...
    public sealed class Test1
    {
        ...
        public void TestAStar()
        {
            ...
            pathTest = aStar.FindPath(startNode.Position, endNode.Position, cells);
        ...
        [TestMethod]
        public void TestAStarPathBlocked()
        {
            ...
            {
                if (entry.Type.Equals(TileTypes.FencePath))
            ...
            CollectionAssert.AreNotEqual(expectedList, pathTest);
        ...
        [TestMethod]
        public void BFSTestPathBlocked()
        {
            Thread.Sleep(1000);
            #region Grid & Edges
            List<Tile> tiles = new List<Tile>();
